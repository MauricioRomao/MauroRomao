...
export const slideData: CarouselSlide[] = [
  {
    ...
    description: React.createElement(React.Fragment, null, "2 anos de experiência profissional com Backend.", React.createElement("br"), "projetar, construir e manter."),
